...
@export var stall_mass_shift: float = 0.5     # How far forward (meters) center of mass shifts in stall
@export var stall_lift_loss: float = 0.8      # Fraction of lift lost at full stall (0.0 to 1.0)
...
func _physics_process(delta: float) -> void:
	...
	# Apply lift - with stall-based center of mass shift
	var stall_offset: Vector3 = fwd * stall_mass_shift * stall_severity
	rb.apply_force(lift_force, stall_offset)

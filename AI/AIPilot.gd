...
@export var bomb_debug_markers_enabled: bool = false
@export var bomb_debug_print_enabled: bool = false
...
@export var flight_path_alignment_debug_enabled: bool = false

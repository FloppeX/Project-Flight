...
@export var turbulence_max_volume_db: float = -32.0
@export var turbulence_min_volume_db: float = -50.0
...
@export var air_rush_min_volume_db: float = -48.0
@export var air_rush_max_volume_db: float = -28.0

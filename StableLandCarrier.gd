...
# =============================================================================
# STABLE LAND CARRIER - Stable version with elevator integration
# =============================================================================
...
func _ready():
	...
	# Set up elevator system
	setup_elevator()
	
	print("Stable Land Carrier ready with elevator at position: ", global_position)
...
func setup_elevator():
	...
	add_child(elevator)
	elevator.setup(self)
	print("Elevator system integrated")

func get_elevator() -> CarrierElevator:
